...
const Dashboard = () => {
  ...
  const recentActivities = [
    ...
    {
      id: 3,
      action: 'Launched CRM application',
      time: '3 hours ago',
      type: 'info',
    },
    {
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <div className={`w-8 h-8 rounded-md flex items-center justify-center ${
                    stat.changeType === 'positive' ? 'bg-success-100 text-success-600' :
                    stat.changeType === 'negative' ? 'bg-error-100 text-error-600' :
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {quickActions.map((action) => (
                <button
                  key={action.name}
                  className={`p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-${action.color}-300 hover:bg-${action.color}-50 transition-colors text-left`}
                >
